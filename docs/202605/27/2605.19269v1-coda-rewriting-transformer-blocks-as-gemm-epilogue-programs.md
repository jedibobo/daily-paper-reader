...
date: 2026-05-19
pdf: "https://arxiv.org/pdf/2605.19269v1"
tags: ["query:hwnas"]
score: 8.0
evidence: 通过将 Transformer 块重写为 GEMM-epilogue 程序来最大化计算利用率
tldr: CODA 通过将内存受限算子融合到 GEMM 内核中来优化 Transformer 训练，减少数据移动。
selection_source: fresh_fetch
motivation: 通过将 Transformer 块重写为 GEMM-epilogue 程序来最大化计算利用率。
