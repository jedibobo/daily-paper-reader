...
tldr: 针对飞机健康诊断中精度与计算资源的矛盾，本文提出了一种长微尺度级联诊断框架（LMSD）。该框架通过任务解耦，将全局异常检测与微观故障分类分离，解决了感受野悖论，并结合知识蒸馏增强了可解释性。在NGAFID数据集上的实验表明，该方法在提升安全关键指标的同时，显著降低了训练开销并实现了模型压缩，非常适合资源受限的航空环境部署。
selection_source: fresh_fetch
motivation: 旨在解决真实航空场景下，飞机故障诊断在处理极端类别不平衡和环境不确定性时，难以兼顾诊断精度与计算效率的问题。
method: 提出LMSD框架，通过异构任务解耦将全局全序列注意力机制与受限感受野的微观分类相结合，并引入知识蒸馏模块提供物理可追溯的解释。
result: "在大型飞行数据集上，该方法使安全关键指标提升了4-8%，同时训练速度提高4.2倍，模型体积压缩了46%。"
conclusion: 该任务解耦框架有效平衡了航空安全与诊断效率，为资源受限环境下的可部署智能故障诊断提供了高效且可解释的工程方案。
---
